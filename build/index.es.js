...
var _args = [
	[
		"axios@0.19.2",
		"/Users/leonkoole/Projects/Appmantle/react-airlock"
	]
];
...
var _spec = "0.19.2";
var _where = "/Users/leonkoole/Projects/Appmantle/react-airlock";
var author = {
	name: "Matt Zabriskie"
};
var browser$1 = {
...
var AirlockContext = createContext({});
...
var Airlock = /** @class */ (function (_super) {
    ...
    Airlock.prototype.signIn = function (email, password) {
        ...
        return new Promise(function (resolve, reject) {
            // Get CSRF cookie
            axios$1.get(api_url + "/" + csrf_cookie_route).then(function () {
                ...
                axios$1
                    ...
                    axios$1.get(api_url + "/" + user_object_route).then(function (_a) {
                        var data = _a.data;
    ...
    Airlock.prototype.render = function () {
        return (createElement(AirlockContext.Provider, { children: this.props.children || null, value: {
...
var withAirlock = function (Component) {
    var C = function (props) {
        ...
        return (createElement(AirlockContext.Consumer, null, function (context) {
            invariant(context, "You should not use <" + displayName + " /> outside a <Airlock>");
            return (createElement(Component, __assign({}, remainingProps, context, { ref: wrappedComponentRef })));
        }));
    };
    return hoistNonReactStatics_cjs(C, Component);
};

export { Airlock, AirlockContext, withAirlock };
