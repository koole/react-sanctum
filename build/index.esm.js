...
var SanctumContext = createContext({});
...
var Sanctum = /** @class */ (function (_super) {
    ...
    Sanctum.prototype.render = function () {
        return (createElement(SanctumContext.Provider, { children: this.props.children || null, value: {
...
var withSanctum = function (Component) {
    ...
    var C = function (props) {
        return (createElement(SanctumContext.Consumer, null, function (context) {
            invariant(context, "You should not use <" + displayName + " /> outside a <Sanctum>");
            return createElement(Component, __assign({}, props, context));
        }));
    };
...
export { Sanctum, SanctumContext, withSanctum };
